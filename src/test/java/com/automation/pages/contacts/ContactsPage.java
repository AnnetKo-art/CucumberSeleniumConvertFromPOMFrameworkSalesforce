...
public class ContactsPage extends BasePage {
	...
	public ContactsPage(WebDriver driver) {
		...
		public  WebDriver popUpWindowHandleWithDriver() throws InterruptedException  {
			popUpWindowHandle(closeButtonOfPopUpWindow);
			return driver;
		}	
		...
		public void elementCreateNewViewLinkIsDisplayed() {
			ifElementDisplayed(createNewViewLink, "Link to create a new view link");
		}
		
		public void dropDownIsDisplayed() {
			ifElementDisplayed(selectDropDownRecentlyModified, "DropDown Recently Modified is displayed");
		}
		...
		public void selectDropDownRecentlyCreated() {
			dropdownHandleByValue(" View DropDown Option in Recently Modified ", selectDropDownRecentlyModified, "Recently Modified");
		}
		...
		public String checkVisibleOptionInDropDown() {
			String visibleOptionFromDropDown = readVisibleOptionInDropDown(selectDropDownRecentlyModified);
			return visibleOptionFromDropDown;
		}
